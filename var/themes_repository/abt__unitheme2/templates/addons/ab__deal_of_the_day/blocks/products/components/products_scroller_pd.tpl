                            ...
                            <div class="ut2-gl__body" {if $settings.abt__ut2.product_list.$tmpl.grid_item_height[$settings.abt__device]}style="min-height: {$settings.abt__ut2.product_list.$tmpl.grid_item_height[$settings.abt__device]|intval}px"{/if}>
                                <div class="ut2-gl__image">
                                    ...
                                    <div class="ut2-gl__buttons">
                                        {if $block.properties.enable_quick_view == "Y" && $settings.ab__device != "mobile"}
                                ...
                                <div class="ut2-gl__content{if $settings.abt__ut2.product_list.price_position_top|default:{"YesNo::YES"|enum} == "YesNo::YES"|enum} price-position-top{/if}">
