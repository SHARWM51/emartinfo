<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:06:47
         compiled from "/home/emartinf/public_html/design/backend/templates/pickers/categories/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2018421881627b9fcfcaa1a4-03492439%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '093aad2365963b4331de379ea9b363073af9c0a6' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/pickers/categories/picker.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2018421881627b9fcfcaa1a4-03492439',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b9fcfd24f31_51585650',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b9fcfd24f31_51585650')) {function content_627b9fcfd24f31_51585650($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/emartinf/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
<?php } else { ?>
    <?php $_smarty_tpl->tpl_vars['_but_title'] = new Smarty_variable($_smarty_tpl->__("select_categories"), null, 0);?>
<?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['view_mode']->value!="list") {?>
            ...
            <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['company_id']||$_smarty_tpl->tpl_vars['runtime']->value['controller']!="companies") {?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['multiple']->value) {?>
                    <?php $_smarty_tpl->tpl_vars['_but_text'] = new Smarty_variable(isset($_smarty_tpl->tpl_vars['but_text']->value) ? ($_smarty_tpl->tpl_vars['but_text']->value) : ($_smarty_tpl->__("add_categories")), null, 0);?>
                ...
                <?php } else { ?>
                    <?php $_smarty_tpl->tpl_vars['icon_class'] = new Smarty_variable($_smarty_tpl->tpl_vars['but_role']->value ? '' : "icon-plus", null, 0);?>
                    ...
                    <?php $_smarty_tpl->tpl_vars['_but_role'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['but_role']->value)===null||$tmp==='' ? "icon" : $tmp), null, 0);?>
                    <?php $_smarty_tpl->tpl_vars['_but_icon'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['but_icon']->value)===null||$tmp==='' ? '' : $tmp), null, 0);?>
                <?php }?>
...
<?php if (!$_smarty_tpl->tpl_vars['extra_var']->value&&$_smarty_tpl->tpl_vars['view_mode']->value!="button") {?>
    ...
    <div id="categories_table_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
...
_no_item"<?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?> class="hidden"<?php }?>>
        <tr>
            <td colspan="<?php if ($_smarty_tpl->tpl_vars['positions']->value) {?>3<?php } else { ?>2<?php }?>"><p class="no-items"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['no_item_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("no_items") : $tmp);?>
</p></td>
        </tr>
        </tbody>
    </table>
