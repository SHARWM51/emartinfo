<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:37:33
         compiled from "/home/emartinf/public_html/design/backend/templates/views/block_manager/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1132817725627b98f5e163b0-08394995%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f34b1005aa2bc67fa6cca831b9b1c91f1645f92' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/block_manager/manage.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1132817725627b98f5e163b0-08394995',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b98f5e99838_20307652',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b98f5e99838_20307652')) {function content_627b98f5e99838_20307652($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_render_location')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.render_location.php';
?><?php
...
">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"block_manager:manage_location")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"block_manager:manage_location"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"block_manager:manage_location"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value['name'], ENT_QUOTES, 'UTF-8');?>
    ...
    <div class="sidebar-row layouts">
        ...
        <ul class="unstyled">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"layouts:layout_page_sidebar")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"layouts:layout_page_sidebar"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

                <li><?php echo $_smarty_tpl->__("dispatch");?>
: <span class="wrap"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['dispatch'], ENT_QUOTES, 'UTF-8');?>
</span></li>
                <li><?php echo $_smarty_tpl->__("name");?>
: <span class="wrap-word"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['location']->value['name'], ENT_QUOTES, 'UTF-8');?>
</span></li>
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"layouts:layout_page_sidebar"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

        </ul>

        <div class="sidebar-field text-right">
            <?php ob_start();
echo htmlspecialchars(fn_url("block_manager.update_location?location=".((string)$_smarty_tpl->tpl_vars['location']->value['location_id'])."&s_layout=".((string)$_smarty_tpl->tpl_vars['location']->value['layout_id'])), ENT_QUOTES, 'UTF-8');
$_tmp4=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"dialog",'text'=>$_smarty_tpl->__("layout_meta_data"),'class'=>"cm-dialog-opener right",'href'=>$_tmp4,'title'=>((string)$_smarty_tpl->tpl_vars['location']->value['name'])));?>
