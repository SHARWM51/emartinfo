<?php /* Smarty version Smarty-3.1.21, created on 2022-05-12 06:48:37
         compiled from "/home/emartinf/public_html/design/backend/templates/views/products/components/picker/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:889460631627c606d86c1d4-88579395%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c47923ddcdf3b805473f8296170d3a5ce40bf006' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/products/components/picker/picker.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '889460631627c606d86c1d4-88579395',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627c606d8aa041_49276263',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627c606d8aa041_49276263')) {function content_627c606d8aa041_49276263($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_to_json')) include '/home/emartinf/public_html/app/functions/smarty_plugins/modifier.to_json.php';
?><?php
...
$_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("pickers/products/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('picker_id'=>((string)$_smarty_tpl->tpl_vars['advanced_picker_id']->value),'data_id'=>"om",'no_container'=>true,'icon'=>"icon-reorder",'but_text'=>$_tmp1,'show_but_text'=>false,'view_mode'=>"button",'meta'=>"object-picker__advanced-btn object-picker__advanced-btn--products ".((string)$_smarty_tpl->tpl_vars['object_picker_advanced_btn_class']->value)), 0);?>
...
$_tmp3=ob_get_clean();?><?php echo htmlspecialchars(fn_url("products.get_products_list?".$_tmp2.$_tmp3), ENT_QUOTES, 'UTF-8');?>
"
...
<?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars(smarty_modifier_to_json(array(array("id"=>0,"text"=>$_tmp4))), ENT_QUOTES, 'UTF-8');?>
"
                    <?php }?>
            >
...
<?php $_tmp5=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['result_title_post']->value, ENT_QUOTES, 'UTF-8');?>
<?php $_tmp6=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item_extended.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"result",'title_pre'=>$_tmp5,'title_post'=>$_tmp6), 0);?>
...
<?php $_tmp7=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selection_title_post']->value, ENT_QUOTES, 'UTF-8');?>
<?php $_tmp8=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item_extended.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"selection",'title_pre'=>$_tmp7,'title_post'=>$_tmp8), 0);?>
...
<?php $_tmp10=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("views/products/components/picker/item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"selection",'title_pre'=>$_tmp9,'title_post'=>$_tmp10), 0);?>
