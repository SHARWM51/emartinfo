<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:09:42
         compiled from "/home/emartinf/public_html/design/backend/templates/views/themes/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:124912258627b926ee20c46-12301727%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '924a37ce51afd004b2aab96270ec2da224fc97e9' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/themes/manage.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '124912258627b926ee20c46-12301727',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b926eec6aa8_15306087',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b926eec6aa8_15306087')) {function content_627b926eec6aa8_15306087($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_split')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.split.php';
                ...
                <table class="table table-middle table--relative table-responsive">
                    <thead>
                        <tr>
                            ...
                            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"themes:list_extra_th")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"themes:list_extra_th"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"themes:list_extra_th"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['available_layout']->value['name'], ENT_QUOTES, 'UTF-8');?>
</td>
...
$_smarty_tpl->tpl_vars['styles_descr']->value[$_smarty_tpl->tpl_vars['style']->value['style_id']] = $_smarty_tpl->tpl_vars['style']->value['name'];?>
                                ...
                                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"themes:list_extra_td")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"themes:list_extra_td"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"themes:list_extra_td"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

                                <td class="right btn-toolbar btn-toolbar--theme-editor" data-th="&nbsp;">
                                    <?php if ($_smarty_tpl->tpl_vars['available_layout']->value['is_default']) {?>
                                        <?php $_smarty_tpl->tpl_vars['default_layout_name'] = new Smarty_variable($_smarty_tpl->tpl_vars['available_layout']->value['name'], null, 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['theme_logos']->value) {?>
    <?php echo $_smarty_tpl->getSubTemplate ("views/themes/components/logos_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('logos'=>$_smarty_tpl->tpl_vars['theme_logos']->value,'company_id'=>$_smarty_tpl->tpl_vars['id']->value,'default_layout_name'=>(($tmp = @$_smarty_tpl->tpl_vars['default_layout_name']->value)===null||$tmp==='' ? '' : $tmp)), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['theme_logos']->value) {?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[themes.update_logos]",'but_role'=>"action",'but_target_form'=>"update_logos_form",'but_meta'=>"cm-submit"), 0);?>
