<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:13:47
         compiled from "/home/emartinf/public_html/design/backend/templates/common/saved_search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1420395194627b936365e357-19503644%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c6d6143893c07db9bdc56c2807c4748659f75fb' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/common/saved_search.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1420395194627b936365e357-19503644',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b936368d998_11156442',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b936368d998_11156442')) {function content_627b936368d998_11156442($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/emartinf/public_html/app/functions/smarty_plugins/block.hook.php';
...
" class="collapsed cm-combination cm-save-state <?php if ($_COOKIE[$_smarty_tpl->tpl_vars['s_id']->value]) {?>hidden<?php }?>">
                                        <?php echo $_smarty_tpl->__("more");
echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"icon-caret-down"),$_smarty_tpl);?>

                                    </a>
                                    <a id="off_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['s_id']->value, ENT_QUOTES, 'UTF-8');?>
" class="cm-combination cm-save-state <?php if (!$_COOKIE[$_smarty_tpl->tpl_vars['s_id']->value]) {?>hidden<?php }?>">
                                        <?php echo $_smarty_tpl->__("more");
echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"icon-caret-down"),$_smarty_tpl);?>
