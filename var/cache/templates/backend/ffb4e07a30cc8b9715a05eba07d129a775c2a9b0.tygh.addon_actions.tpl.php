<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 18:38:44
         compiled from "/home/emartinf/public_html/design/backend/templates/views/addons/components/addons/addon_actions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1834345549627bb55ca218a6-91524375%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ffb4e07a30cc8b9715a05eba07d129a775c2a9b0' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/addons/components/addons/addon_actions.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1834345549627bb55ca218a6-91524375',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627bb55ca53b72_15895793',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627bb55ca53b72_15895793')) {function content_627bb55ca53b72_15895793($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/home/emartinf/public_html/app/functions/smarty_plugins/modifier.enum.php';
?><?php
...
$_tmp20=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['action_btn_text'] = new Smarty_variable($_smarty_tpl->tpl_vars['a']->value['main_page'] ? "<span class=\"caret\"></span>" : $_tmp20." <span class=\"caret\"></span>", null, 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['a']->value['status']===smarty_modifier_enum("ObjectStatuses::ACTIVE")&&$_smarty_tpl->tpl_vars['a']->value['menu_items']) {?>
    <?php $_smarty_tpl->tpl_vars['position'] = new Smarty_variable("10", null, 0);?>
<?php } elseif ($_smarty_tpl->tpl_vars['a']->value['status']===smarty_modifier_enum("ObjectStatuses::ACTIVE")) {?>
    <?php $_smarty_tpl->tpl_vars['position'] = new Smarty_variable("20", null, 0);?>
<?php } elseif ($_smarty_tpl->tpl_vars['a']->value['status']===smarty_modifier_enum("ObjectStatuses::DISABLED")) {?>
    <?php $_smarty_tpl->tpl_vars['position'] = new Smarty_variable("30", null, 0);?>
<?php } elseif ($_smarty_tpl->tpl_vars['a']->value['status']===smarty_modifier_enum("ObjectStatuses::NEW_OBJECT")) {?>
    <?php $_smarty_tpl->tpl_vars['position'] = new Smarty_variable("40", null, 0);?>
<?php }?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['a']->value['short_name'], ENT_QUOTES, 'UTF-8');?>
...
"
            ...
            <?php }?>
    <?php } elseif ($_smarty_tpl->tpl_vars['a']->value['status']===smarty_modifier_enum("ObjectStatuses::DISABLED")) {?>
        <?php if ($_smarty_tpl->tpl_vars['a']->value['is_disabled']===true) {?>
...
$_tmp21=ob_get_clean();?><?php echo htmlspecialchars(fn_url("addons.update_status?id=".((string)$_smarty_tpl->tpl_vars['key']->value)."&status=".$_tmp21."&redirect_url=".((string)rawurlencode($_smarty_tpl->tpl_vars['c_url']->value))), ENT_QUOTES, 'UTF-8');?>
"
