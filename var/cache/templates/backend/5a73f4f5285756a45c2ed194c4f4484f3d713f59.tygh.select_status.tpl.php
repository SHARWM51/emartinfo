<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:13:42
         compiled from "/home/emartinf/public_html/design/backend/templates/common/select_status.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1230769026627b935e9efbf8-66813748%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a73f4f5285756a45c2ed194c4f4484f3d713f59' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/common/select_status.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1230769026627b935e9efbf8-66813748',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b935ea31fe5_56174848',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b935ea31fe5_56174848')) {function content_627b935ea31fe5_56174848($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.script.php';
...
?>
<?php if ($_smarty_tpl->tpl_vars['display']->value=="select"||$_smarty_tpl->tpl_vars['display']->value=="popup"||$_smarty_tpl->tpl_vars['display']->value=="text") {?>
...
<?php } else { ?>
<?php $_smarty_tpl->tpl_vars['can_be_disabled'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['can_be_disabled']->value)===null||$tmp==='' ? true : $tmp), null, 0);?>
<div class="control-group">
    <label class="control-label cm-required"><?php echo $_smarty_tpl->__("status");?>
:</label>
    <div class="controls">
...
" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['obj_id']->value)===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'UTF-8');?>
_d" <?php if ($_smarty_tpl->tpl_vars['obj']->value['status']===smarty_modifier_enum("ObjectStatuses::DISABLED")) {?>checked="checked"<?php }?> value="<?php echo htmlspecialchars(smarty_modifier_enum("ObjectStatuses::DISABLED"), ENT_QUOTES, 'UTF-8');?>
