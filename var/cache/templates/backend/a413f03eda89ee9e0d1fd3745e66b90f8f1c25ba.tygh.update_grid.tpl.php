<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 21:41:19
         compiled from "/home/emartinf/public_html/design/backend/templates/views/block_manager/update_grid.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1213764968627be02790a554-15064208%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a413f03eda89ee9e0d1fd3745e66b90f8f1c25ba' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/block_manager/update_grid.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1213764968627be02790a554-15064208',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627be027970cf7_88224552',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627be027970cf7_88224552')) {function content_627be027970cf7_88224552($_smarty_tpl) {?><?php if (!is_callable('smarty_function_include_ext')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.include_ext.php';
...
" name="width" data-ca-grid-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
">
...
"><?php echo $_smarty_tpl->__("offset");?>
        ...
        <div class="controls">
            <?php $_smarty_tpl->tpl_vars['maxOffset'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['grid_params']->value['max_offset'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['grid_params']->value['max_width'] : $tmp), null, 0);?>
            <select id="elm_grid_offset_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['elm_id']->value, ENT_QUOTES, 'UTF-8');?>
" name="offset" data-ca-grid-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
">
...
$_smarty_tpl->tpl_vars['smarty']->value['section']["offset"]['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['maxOffset']->value) ? count($_loop) : max(0, (int) $_loop); unset($_loop);
