<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:03:41
         compiled from "/home/emartinf/public_html/design/backend/templates/views/companies/components/companies_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1306544305627b9f157b87d1-90737654%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '805207a7c919b65e2ef60032044b336b7592a119' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/companies/components/companies_search_form.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1306544305627b9f157b87d1-90737654',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b9f157e9c50_83057675',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b9f157e9c50_83057675')) {function content_627b9f157e9c50_83057675($_smarty_tpl) {?><?php if (!is_callable('smarty_function_array_to_fields')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.array_to_fields.php';
...
" disabled="disabled"/>
    ...
    <div class="control-group">
        ...
        <select name="status" id="status">
            <option value="">--</option>
            <option value="<?php echo htmlspecialchars(smarty_modifier_enum("VendorStatuses::ACTIVE"), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['status']==smarty_modifier_enum("VendorStatuses::ACTIVE")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("active");?>
            ...
            <option value="<?php echo htmlspecialchars(smarty_modifier_enum("VendorStatuses::PENDING"), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['status']==smarty_modifier_enum("VendorStatuses::PENDING")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("pending");?>
            ...
            <option value="<?php echo htmlspecialchars(smarty_modifier_enum("VendorStatuses::SUSPENDED"), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['status']==smarty_modifier_enum("VendorStatuses::SUSPENDED")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("suspended");?>
            ...
            <option value="<?php echo htmlspecialchars(smarty_modifier_enum("VendorStatuses::NEW_ACCOUNT"), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['status']==smarty_modifier_enum("VendorStatuses::NEW_ACCOUNT")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("new");?>
            ...
            <option value="<?php echo htmlspecialchars(smarty_modifier_enum("VendorStatuses::DISABLED"), ENT_QUOTES, 'UTF-8');?>
