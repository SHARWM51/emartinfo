<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:37:32
         compiled from "/home/emartinf/public_html/design/backend/templates/views/pages/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:810652312627b98f4d82f96-31188225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '06e8ad9e6331e789568c6e03f04c6ec058e760a5' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/pages/update.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '810652312627b98f4d82f96-31188225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b98f4e1a1c5_37868656',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b98f4e1a1c5_37868656')) {function content_627b98f4e1a1c5_37868656($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/emartinf/public_html/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['id']->value&&$_smarty_tpl->tpl_vars['page_type']->value!=(defined('PAGE_TYPE_LINK') ? constant('PAGE_TYPE_LINK') : null)&&(!fn_allowed_for("ULTIMATE")||$_smarty_tpl->tpl_vars['runtime']->value['company_id'])) {?>
    <?php $_smarty_tpl->tpl_vars['view_uri'] = new Smarty_variable(fn_get_preview_url("pages.view?page_id=".((string)$_smarty_tpl->tpl_vars['id']->value),$_smarty_tpl->tpl_vars['page_data']->value,$_smarty_tpl->tpl_vars['auth']->value['user_id'],$_smarty_tpl->tpl_vars['default_language']->value), null, 0);?>
<?php }?>
...
:</label>
            ...
            <div class="controls">
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"pages:detailed_description_textarea")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"pages:detailed_description_textarea"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
"
                ...
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"pages:detailed_description_textarea"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
:</label>
              <div class="controls">
                  <?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('date_id'=>"elm_page_date",'date_name'=>"page_data[timestamp]",'date_val'=>(($tmp = @$_smarty_tpl->tpl_vars['page_data']->value['timestamp'])===null||$tmp==='' ? (defined('TIME') ? constant('TIME') : null) : $tmp),'start_year'=>$_smarty_tpl->tpl_vars['settings']->value['Company']['company_start_year']), 0);?>
...
:</label>
              <div class="controls">
                  <?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('date_id'=>"elm_page_avail_from",'date_name'=>"page_data[avail_from_timestamp]",'date_val'=>(($tmp = @$_smarty_tpl->tpl_vars['page_data']->value['avail_from_timestamp'])===null||$tmp==='' ? (defined('TIME') ? constant('TIME') : null) : $tmp),'start_year'=>$_smarty_tpl->tpl_vars['settings']->value['Company']['company_start_year'],'extra'=>Smarty::$_smarty_vars['capture']['calendar_disable']), 0);?>
...
:</label>
              <div class="controls">
                  <?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('date_id'=>"elm_page_avail_till",'date_name'=>"page_data[avail_till_timestamp]",'date_val'=>(($tmp = @$_smarty_tpl->tpl_vars['page_data']->value['avail_till_timestamp'])===null||$tmp==='' ? (defined('TIME') ? constant('TIME') : null) : $tmp),'start_year'=>$_smarty_tpl->tpl_vars['settings']->value['Company']['company_start_year'],'extra'=>Smarty::$_smarty_vars['capture']['calendar_disable']), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>$_smarty_tpl->tpl_vars['id']->value ? $_smarty_tpl->tpl_vars['page_data']->value['page'] : $_smarty_tpl->__($_smarty_tpl->tpl_vars['page_type_data']->value['new_name']),'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'sidebar_position'=>"left",'select_languages'=>(bool) $_smarty_tpl->tpl_vars['id']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons']), 0);?>
