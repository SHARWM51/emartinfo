<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:06:42
         compiled from "/home/emartinf/public_html/design/backend/templates/common/object_group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:25064434627b9fca2c77b1-64470372%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a26c4223ff33361e4db077c727dfb195cb47340' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/common/object_group.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '25064434627b9fca2c77b1-64470372',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b9fca30b704_79852896',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b9fca30b704_79852896')) {function content_627b9fca30b704_79852896($_smarty_tpl) {?><?php
...
" <?php }?>
                    data-th="&nbsp;"
                    class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['checkbox_col_class']->value, ENT_QUOTES, 'UTF-8');?>
"
                >
...
" />
            ...
            <?php }?>
                ...
                <td width="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['href_col_width']->value)===null||$tmp==='' ? ($_smarty_tpl->tpl_vars['href_desc']->value ? "77%" : "28%") : $tmp), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['href_desc_row_hint']->value) {?>data-th="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_desc_row_hint']->value, ENT_QUOTES, 'UTF-8');?>
...
"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['text']->value)===null||$tmp==='' ? $_smarty_tpl->__("view") : $tmp), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['storefront_name']->value) {?><div><small><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['storefront_name']->value, ENT_QUOTES, 'UTF-8');?>
</small></div><?php }?>
                ...
                <td width="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['details_col_width']->value)===null||$tmp==='' ? ($_smarty_tpl->tpl_vars['href_desc']->value ? "0%" : "50%") : $tmp), ENT_QUOTES, 'UTF-8');?>
" data-th="&nbsp;">
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <?php if (!$_smarty_tpl->tpl_vars['nostatus']->value) {?>
                    <td width="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['last_col_width']->value)===null||$tmp==='' ? "12%" : $tmp), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['status_row_hint']->value) {?>data-th="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status_row_hint']->value, ENT_QUOTES, 'UTF-8');?>
"<?php } else { ?>data-th="&nbsp;"<?php }?>>
