<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:07:09
         compiled from "/home/emartinf/public_html/design/backend/templates/views/block_manager/update_block.tpl" */ ?>
<?php /*%%SmartyHeaderCode:907477056627b9fe5731e25-50649555%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '318b7deac552bbbd94c79e1da3c20aa80c5b589d' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/block_manager/update_block.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '907477056627b9fe5731e25-50649555',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b9fe57df606_68488697',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b9fe57df606_68488697')) {function content_627b9fe57df606_68488697($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.script.php';
...
" class="cm-no-hide-input" />
                ...
                <?php if ($_smarty_tpl->tpl_vars['block']->value['object_id']>0) {?>
                    <div class="text-tip">
                        <?php $_smarty_tpl->tpl_vars["url"] = new Smarty_variable(fn_url(((string)$_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['customer_dispatch'])."&".((string)$_smarty_tpl->tpl_vars['dynamic_object_scheme']->value['key'])."=".((string)$_smarty_tpl->tpl_vars['dynamic_object']->value['object_id']),'C','http',(defined('DESCR_SL') ? constant('DESCR_SL') : null)), null, 0);?>
...
" class="cm-no-hide-input" />
    <?php }?>
    <input type="hidden" name="descr_sl" value="<?php echo htmlspecialchars((defined('DESCR_SL') ? constant('DESCR_SL') : null), ENT_QUOTES, 'UTF-8');?>
" class="cm-no-hide-input" />
</form>
<?php }} ?>
