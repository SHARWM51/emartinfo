<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:13:47
         compiled from "/home/emartinf/public_html/design/backend/templates/pickers/products/js.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1314521933627b9363763875-65056601%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6183ae06c1f459bd53adb0ef2cb422b5983607cd' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/pickers/products/js.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1314521933627b9363763875-65056601',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b93637a9193_48294412',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b93637a9193_48294412')) {function content_627b93637a9193_48294412($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/emartinf/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
?>
<?php $_smarty_tpl->tpl_vars['product_data'] = new Smarty_variable(fn_get_product_data($_smarty_tpl->tpl_vars['product_id']->value,$_SESSION['auth'],(defined('CART_LANGUAGE') ? constant('CART_LANGUAGE') : null),"?:products.company_id,?:product_descriptions.product",false,false,false,false,false,false,true), null, 0);?>
...
[aoc]"
            value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['aoc']->value, ENT_QUOTES, 'UTF-8');?>
"
...
[amount]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['amount']->value, ENT_QUOTES, 'UTF-8');?>
" size="3" class="input-micro product-picker__amount"<?php if ($_smarty_tpl->tpl_vars['clone']->value) {?> disabled="disabled"<?php }?> />
    <?php }?>
</td>
    <?php }?>
...
<td class="nowrap">
    <?php if (!$_smarty_tpl->tpl_vars['hide_delete_button']->value&&!$_smarty_tpl->tpl_vars['show_only_name']->value) {?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_smarty_tpl->__("delete"),'onclick'=>"Tygh."."$".".cePicker('delete_js_item', '".((string)$_smarty_tpl->tpl_vars['root_id']->value)."', '".((string)$_smarty_tpl->tpl_vars['delete_id']->value)."', 'p'); return false;"));?>
</li>
...
"><?php if (!$_smarty_tpl->tpl_vars['hide_delete_button']->value&&!$_smarty_tpl->tpl_vars['show_only_name']->value) {?>
            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_smarty_tpl->__("edit"),'href'=>"products.update?product_id=".((string)$_smarty_tpl->tpl_vars['delete_id']->value)));?>
</li>
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_smarty_tpl->__("remove"),'onclick'=>"Tygh."."$".".cePicker('delete_js_item', '".((string)$_smarty_tpl->tpl_vars['root_id']->value)."', '".((string)$_smarty_tpl->tpl_vars['delete_id']->value)."', 'p'); return false;"));?>
</li>
            <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
