<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:34:58
         compiled from "/home/emartinf/public_html/design/backend/templates/common/settings_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:775383477627b985a0fe679-31879920%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d33e778d63075ecf1424b9c893d2b20dfcd2f23' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/common/settings_fields.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '775383477627b985a0fe679-31879920',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b985a1ca211_49710666',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b985a1ca211_49710666')) {function content_627b985a1ca211_49710666($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/home/emartinf/public_html/app/functions/smarty_plugins/block.inline_script.php';
...
if (!is_callable('smarty_modifier_render_tag_attrs')) include '/home/emartinf/public_html/app/functions/smarty_plugins/modifier.render_tag_attrs.php';
...
$_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['default_label_attrs'] = new Smarty_variable(array("for"=>$_smarty_tpl->tpl_vars['html_id']->value,"class"=>"control-label ".$_tmp2), null, 0);?>
...
" <?php if ($_smarty_tpl->tpl_vars['disable_input']->value) {?>disabled="disabled"<?php }?> />
                    <?php echo $_smarty_tpl->getSubTemplate ("common/adaptive_object_selection.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('input_name'=>$_smarty_tpl->tpl_vars['html_name']->value,'input_id'=>"variant_".((string)$_smarty_tpl->tpl_vars['item']->value['name']),'item_ids'=>$_smarty_tpl->tpl_vars['item']->value['value_ids'],'items'=>$_smarty_tpl->tpl_vars['item']->value['variants'],'type'=>$_smarty_tpl->tpl_vars['html_name']->value,'class_prefix'=>$_smarty_tpl->tpl_vars['html_name']->value,'close_on_select'=>"false",'list_mode'=>false,'is_default_array_check'=>false), 0);?>
...
$_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['default_attrs'] = new Smarty_variable(array_merge($_smarty_tpl->tpl_vars['default_attrs']->value,array("id"=>((string)$_smarty_tpl->tpl_vars['html_id']->value),"type"=>"text","name"=>((string)$_smarty_tpl->tpl_vars['html_name']->value),"size"=>"30","class"=>$_tmp3,"placeholder"=>((string)$_smarty_tpl->tpl_vars['input_placeholder']->value),"value"=>((string)$_smarty_tpl->tpl_vars['item']->value['value']))), null, 0);?>
                <input <?php echo smarty_modifier_render_tag_attrs($_smarty_tpl->tpl_vars['input_attrs']->value,$_smarty_tpl->tpl_vars['default_attrs']->value);?>
/>
            <?php }?>
