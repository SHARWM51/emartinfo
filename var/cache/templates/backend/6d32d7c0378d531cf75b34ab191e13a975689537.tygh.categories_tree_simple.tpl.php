<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:23:30
         compiled from "/home/emartinf/public_html/design/backend/templates/views/categories/components/categories_tree_simple.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1795184224627ba3ba170df7-00794774%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d32d7c0378d531cf75b34ab191e13a975689537' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/categories/components/categories_tree_simple.tpl',
      1 => 1650021892,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1795184224627ba3ba170df7-00794774',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627ba3ba1e0ae6_26739129',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627ba3ba1e0ae6_26739129')) {function content_627ba3ba1e0ae6_26739129($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/emartinf/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
    ...
    >
        ...
        <td class="left first-column" width="5%">
            <?php if ($_smarty_tpl->tpl_vars['cur_cat']->value['storefront_categories']) {?>
                &nbsp;
                <?php $_smarty_tpl->tpl_vars["comb_id"] = new Smarty_variable("comp_".((string)$_smarty_tpl->tpl_vars['cur_cat']->value['storefront_id'])."_".((string)$_smarty_tpl->tpl_vars['random']->value), null, 0);?>
...
" 
                       class="cm-item <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['radio_class']->value, ENT_QUOTES, 'UTF-8');?>
"
                />
                <?php } else { ?>
                <input type="checkbox" 
