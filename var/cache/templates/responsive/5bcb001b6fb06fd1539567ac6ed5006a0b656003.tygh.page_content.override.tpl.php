<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:37:52
         compiled from "/home/emartinf/public_html/design/themes/responsive/templates/addons/form_builder/hooks/pages/page_content.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:80232403627b9908124f00-86479568%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5bcb001b6fb06fd1539567ac6ed5006a0b656003' => 
    array (
      0 => '/home/emartinf/public_html/design/themes/responsive/templates/addons/form_builder/hooks/pages/page_content.override.tpl',
      1 => 1652265539,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '80232403627b9908124f00-86479568',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b9908200232_52661924',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b9908200232_52661924')) {function content_627b9908200232_52661924($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/emartinf/public_html/app/functions/smarty_plugins/block.hook.php';
...
?>
    ...
    <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']!=(defined('FORM_IP_ADDRESS') ? constant('FORM_IP_ADDRESS') : null)&&$_smarty_tpl->tpl_vars['element']->value['element_type']!=(defined('FORM_REFERER') ? constant('FORM_REFERER') : null)) {?>
        <div class="ty-control-group">
            <label for="<?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==(defined('FORM_FILE') ? constant('FORM_FILE') : null)) {?>type_<?php echo htmlspecialchars(md5("fb_files[".((string)$_smarty_tpl->tpl_vars['element']->value['element_id'])."]"), ENT_QUOTES, 'UTF-8');
...
" class="ty-form-builder__textarea" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==(defined('FORM_EMAIL') ? constant('FORM_EMAIL') : null)||$_smarty_tpl->tpl_vars['element']->value['element_type']==(defined('FORM_NUMBER') ? constant('FORM_NUMBER') : null)||$_smarty_tpl->tpl_vars['element']->value['element_type']==(defined('FORM_PHONE') ? constant('FORM_PHONE') : null)) {?>
...
if ($_smarty_tpl->tpl_vars['element']->value['element_type']==(defined('FORM_PHONE') ? constant('FORM_PHONE') : null)) {?> cm-mask-phone<?php }?>" size="50" type="text" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'UTF-8');?>
" />
