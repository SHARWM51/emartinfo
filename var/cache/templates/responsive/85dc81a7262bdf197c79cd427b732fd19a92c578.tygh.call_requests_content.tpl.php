<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:13:08
         compiled from "/home/emartinf/public_html/design/themes/responsive/templates/addons/call_requests/views/call_requests/components/call_requests_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1821494920627b933c98baf8-10787840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85dc81a7262bdf197c79cd427b732fd19a92c578' => 
    array (
      0 => '/home/emartinf/public_html/design/themes/responsive/templates/addons/call_requests/views/call_requests/components/call_requests_content.tpl',
      1 => 1652265539,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1821494920627b933c98baf8-10787840',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b933c9c1ba4_22622797',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b933c9c1ba4_22622797')) {function content_627b933c9c1ba4_22622797($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/emartinf/public_html/app/functions/smarty_plugins/block.hook.php';
...
_convenient_time_from" class="ty-control-group__title"><?php echo $_smarty_tpl->__("call_requests.convenient_time");?>
        ...
        <bdi>
            <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_convenient_time_from" class="ty-input-text cm-cr-mask-time" size="6" type="text" name="call_data[time_from]" value="" placeholder="<?php echo htmlspecialchars((defined('CALL_REQUESTS_DEFAULT_TIME_FROM') ? constant('CALL_REQUESTS_DEFAULT_TIME_FROM') : null), ENT_QUOTES, 'UTF-8');?>
" /> -
            <input id="call_data_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_convenient_time_to" class="ty-input-text cm-cr-mask-time" size="6" type="text" name="call_data[time_to]" value="" placeholder="<?php echo htmlspecialchars((defined('CALL_REQUESTS_DEFAULT_TIME_TO') ? constant('CALL_REQUESTS_DEFAULT_TIME_TO') : null), ENT_QUOTES, 'UTF-8');?>
" />
        </bdi>
    </div>
