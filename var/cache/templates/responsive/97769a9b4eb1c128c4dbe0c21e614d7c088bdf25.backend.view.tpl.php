<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:38:04
         compiled from "/home/emartinf/public_html/design/backend/templates/views/theme_editor/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:461110923627ba724f40967-14496082%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97769a9b4eb1c128c4dbe0c21e614d7c088bdf25' => 
    array (
      0 => '/home/emartinf/public_html/design/backend/templates/views/theme_editor/view.tpl',
      1 => 1650021892,
      2 => 'backend',
    ),
  ),
  'nocache_hash' => '461110923627ba724f40967-14496082',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627ba72525a4a8_28472525',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627ba72525a4a8_28472525')) {function content_627ba72525a4a8_28472525($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_to_json')) include '/home/emartinf/public_html/app/functions/smarty_plugins/modifier.to_json.php';
...
if (!is_callable('smarty_modifier_count')) include '/home/emartinf/public_html/app/functions/smarty_plugins/modifier.count.php';
if (!is_callable('smarty_block_hook')) include '/home/emartinf/public_html/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_replace')) include '/home/emartinf/public_html/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
...
">
        <?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"icon-left-open glyph-left-open"),$_smarty_tpl);
echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"icon-right-open glyph-right-open hidden"),$_smarty_tpl);?>
...
"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"icon-cancel glyph-cancel"),$_smarty_tpl);?>
</a>
        </span>
</span>
...
&nbsp;<?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"ty-icon-help-circle cm-tooltip",'title'=>$_smarty_tpl->__('theme_editor.text_convert_to_css')),$_smarty_tpl);?>
</span>
                </a>
            <?php }?>
...
</span><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"ty-icon-d-arrow"),$_smarty_tpl);?>
...
">
                                    <?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"ty-icon-docs",'title'=>$_smarty_tpl->__("clone")),$_smarty_tpl);?>
...
"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"ty-icon-trashcan",'title'=>$_smarty_tpl->__("delete")),$_smarty_tpl);?>
</a>
                                <?php }?>
                            </li>
                        <?php }
...
</span><?php echo $_smarty_tpl->getSubTemplate ("backend:views/theme_editor/components/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('var_name'=>"logotypes_image_icon[".((string)$_smarty_tpl->tpl_vars['id']->value)."]",'disabled'=>$_smarty_tpl->tpl_vars['current_style']->value['is_default']), 0);?>
...
"><span></span><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"ty-icon-d-arrow"),$_smarty_tpl);?>
...
echo htmlspecialchars(key($_smarty_tpl->tpl_vars['props_schema']->value['fonts']['families']), ENT_QUOTES, 'UTF-8');
}?>">
...
" class="cm-combination te-advanced-options"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-cog"),$_smarty_tpl);?>
</a>
                            <?php }?>
...
" class="te-advanced-options cm-combination"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-cog"),$_smarty_tpl);?>
</a>
...
" />
                                <?php } else { ?>
                                    <?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"ty-icon-image"),$_smarty_tpl);?>
...
?<?php echo htmlspecialchars((defined('TIME') ? constant('TIME') : null), ENT_QUOTES, 'UTF-8');?>
" />
                                                    </div></li>
                                            <?php } ?>
                                            <li class="divider"></li>
...
]" value="top left" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="top left") {?>checked="checked"<?php }?> /><label for="top_left"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-arrow-up-left"),$_smarty_tpl);?>
</label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="top_center" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="top center" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="top center") {?>checked="checked"<?php }?> /><label for="top_center"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-arrow-up"),$_smarty_tpl);?>
</label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="top_right" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="top right" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="top right") {?>checked="checked"<?php }?> /><label for="top_right"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-arrow-up-right"),$_smarty_tpl);?>
</label></div>
                                    </div>
                                    <div class="te-bg-position-wrap clearfix">
...
]" if="center_left" value="center left" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="center left") {?>checked="checked"<?php }?> /><label for="center_left"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-arrow-left"),$_smarty_tpl);?>
</label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="center_center" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="center center" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="center center") {?>checked="checked"<?php }?> /><label for="center_center"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-square"),$_smarty_tpl);?>
</label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="center_right" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="center right" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="center right") {?>checked="checked"<?php }?> /><label for="center_right"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-arrow-right"),$_smarty_tpl);?>
</label></div>
                                    </div>
                                    <div class="te-bg-position-wrap clearfix">
...
]" value="bottom left" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="bottom left") {?>checked="checked"<?php }?> /><label for="bottom_left"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-arrow-down-left"),$_smarty_tpl);?>
</label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="bottom_center" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="bottom center" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="bottom center") {?>checked="checked"<?php }?> /><label for="bottom_center"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-arrow-down"),$_smarty_tpl);?>
</label></div><div class="te-bg-position-item"><input class="cm-te-value-changer" type="radio" id="bottom_right" name="style[data][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['properties']['position'], ENT_QUOTES, 'UTF-8');?>
]" value="bottom right" <?php if ($_smarty_tpl->tpl_vars['current_style']->value['data'][$_smarty_tpl->tpl_vars['field']->value['properties']['position']]=="bottom right") {?>checked="checked"<?php }?> /><label for="bottom_right"><?php echo smarty_function_include_ext(array('file'=>"common/icon.tpl",'class'=>"glyph-arrow-down-right"),$_smarty_tpl);?>
</label></div>
                                    </div>
                                </div>
                            </div>
