<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:38:29
         compiled from "/home/emartinf/public_html/design/themes/responsive/templates/addons/product_reviews/views/product_reviews/components/product_reviews_navigation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2131209181627ba73d4db969-45532349%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6ad4eeea170f0ec9c0a52a62568ad0bfdf38ec53' => 
    array (
      0 => '/home/emartinf/public_html/design/themes/responsive/templates/addons/product_reviews/views/product_reviews/components/product_reviews_navigation.tpl',
      1 => 1652265539,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2131209181627ba73d4db969-45532349',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627ba73d4faa34_51360568',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627ba73d4faa34_51360568')) {function content_627ba73d4faa34_51360568($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
$_tmp17=ob_get_clean();?><?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp17."&selected_section=product_reviews")), ENT_QUOTES, 'UTF-8');?>
"
    ...
    <nav class="ty-product-review-reviews-navigation">
        ...
        <label class="ty-product-review-reviews-navigation__filter <?php if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?>ty-product-review-reviews-navigation__filter--active<?php }?>">
            ...
            <a id="product_review_with_images_link"
                href="<?php ob_start();
if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?><?php echo "0";?><?php } else { ?><?php echo "1";?><?php }
$_tmp18=ob_get_clean();?><?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp18."&selected_section=product_reviews")), ENT_QUOTES, 'UTF-8');?>
"
                class="ty-product-review-reviews-navigation__filter-link cm-ajax"
                data-ca-target-id="pagination_contents_comments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_id']->value, ENT_QUOTES, 'UTF-8');?>
"
