<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 16:10:12
         compiled from "/home/emartinf/public_html/design/themes/responsive/templates/views/profiles/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1047585903627b928c00c103-31230727%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '18a32c6894f68c17df752246d7e8c60efafeaa6f' => 
    array (
      0 => '/home/emartinf/public_html/design/themes/responsive/templates/views/profiles/update.tpl',
      1 => 1652253997,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1047585903627b928c00c103-31230727',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627b928c0b0246_65031698',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627b928c0b0246_65031698')) {function content_627b928c0b0246_65031698($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/home/emartinf/public_html/app/functions/smarty_plugins/modifier.enum.php';
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="add"&&$_smarty_tpl->tpl_vars['settings']->value['General']['quick_registration']==smarty_modifier_enum("YesNo::YES")) {?>
    <div class="ty-account">
        ...
        <form name="profiles_register_form" enctype="multipart/form-data" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'UTF-8');?>
" method="post">
            <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profile_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('section'=>"C",'nothing_extra'=>smarty_modifier_enum("YesNo::YES")), 0);?>

            <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profiles_account.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('nothing_extra'=>smarty_modifier_enum("YesNo::YES"),'location'=>"checkout"), 0);?>


            <?php if ($_REQUEST['return_url']) {?>
                <input type="hidden" name="return_url" value="<?php echo htmlspecialchars($_REQUEST['return_url'], ENT_QUOTES, 'UTF-8');?>
" />
            <?php }?>
...
>
                        <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['show_delete_account_button']===smarty_modifier_enum("YesNO::YES")&&$_smarty_tpl->tpl_vars['user_data']->value['user_type']===smarty_modifier_enum("UserTypes::CUSTOMER")) {?>
                            <?php $_smarty_tpl->_capture_stack[0][] = array("delete_my_account", null, null); ob_start(); ?>
                                <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/user_action_popup.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('action'=>"anonymization_request",'description'=>$_smarty_tpl->__("delete_my_account_description"),'title'=>$_smarty_tpl->__("delete_my_account"),'id'=>$_smarty_tpl->tpl_vars['block']->value['block_id']), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('link_text'=>$_smarty_tpl->__("delete_my_account"),'title'=>$_smarty_tpl->__("delete_my_account"),'id'=>"anonymization_request_dialog_".((string)$_smarty_tpl->tpl_vars['block']->value['block_id']),'content'=>Smarty::$_smarty_vars['capture']['delete_my_account'],'link_meta'=>"ty-ml-s"), 0);?>
