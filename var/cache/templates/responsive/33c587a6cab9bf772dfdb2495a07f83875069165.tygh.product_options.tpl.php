<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:38:28
         compiled from "/home/emartinf/public_html/design/themes/responsive/templates/views/products/components/product_options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1770900353627ba73c811991-67096953%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33c587a6cab9bf772dfdb2495a07f83875069165' => 
    array (
      0 => '/home/emartinf/public_html/design/themes/responsive/templates/views/products/components/product_options.tpl',
      1 => 1652253997,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1770900353627ba73c811991-67096953',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627ba73c98ffc7_55145740',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627ba73c98ffc7_55145740')) {function content_627ba73c98ffc7_55145740($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/home/emartinf/public_html/app/functions/smarty_plugins/modifier.enum.php';
...
if (trim($_smarty_tpl->tpl_vars['po']->value['description'])) {
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->tpl_vars['po']->value['description']), 0);
}?>:
                </label>
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['show_modifiers']->value) {?>
                                            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:options_modifiers")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:options_modifiers"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                                                ...
                                                <?php if (floatval($_smarty_tpl->tpl_vars['vr']->value['modifier'])) {?>
                                                    (<?php echo preg_replace('!\s+!u', '',preg_replace('!<[^>]*?>!', ' ', Smarty::$_smarty_vars['capture']['modifier']));?>
)
                                                <?php }?>
...
"
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['po']->value['option_type']==smarty_modifier_enum("ProductOptionTypes::CHECKBOX")) {?> 
                <?php $_smarty_tpl->tpl_vars['default_variant_disabled'] = new Smarty_variable(false, null, 0);?>
                <?php  $_smarty_tpl->tpl_vars['vr'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['vr']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['po']->value['variants']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['vr']->key => $_smarty_tpl->tpl_vars['vr']->value) {
$_smarty_tpl->tpl_vars['vr']->_loop = true;
?>
                    <?php if ($_smarty_tpl->tpl_vars['vr']->value['position']==0) {?>
                        <?php $_smarty_tpl->tpl_vars['default_variant_disabled'] = new Smarty_variable(($_smarty_tpl->tpl_vars['po']->value['disabled']||$_smarty_tpl->tpl_vars['vr']->value['disabled'])||($_smarty_tpl->tpl_vars['disabled']->value&&$_smarty_tpl->tpl_vars['po']->value['value']!=$_smarty_tpl->tpl_vars['vr']->value['variant_id']), null, 0);?>
...
?>
                        <?php if ($_smarty_tpl->tpl_vars['var']->value['image_pair']['image_id']) {?>
                            ...
                            <?php }?>
                            <?php echo $_smarty_tpl->getSubTemplate ("common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('class'=>((string)$_smarty_tpl->tpl_vars['_class']->value)." ty-product-options__image",'images'=>$_smarty_tpl->tpl_vars['var']->value['image_pair'],'image_width'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_variant_mini_icon_width'],'image_height'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_variant_mini_icon_height'],'obj_id'=>"variant_image_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['id']->value)."_".((string)$_smarty_tpl->tpl_vars['po']->value['option_id'])."_".((string)$_smarty_tpl->tpl_vars['var']->value['variant_id']),'image_onclick'=>"fn_set_option_value('".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['id']->value)."', '".((string)$_smarty_tpl->tpl_vars['po']->value['option_id'])."', '".((string)$_smarty_tpl->tpl_vars['var']->value['variant_id'])."'); void(0);"), 0);?>
