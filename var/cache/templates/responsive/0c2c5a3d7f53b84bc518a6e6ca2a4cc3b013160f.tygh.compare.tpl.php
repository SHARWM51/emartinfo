<?php /* Smarty version Smarty-3.1.21, created on 2022-05-12 07:12:02
         compiled from "/home/emartinf/public_html/design/themes/responsive/templates/views/product_features/compare.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1509295855627c65ea564c13-97159509%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c2c5a3d7f53b84bc518a6e6ca2a4cc3b013160f' => 
    array (
      0 => '/home/emartinf/public_html/design/themes/responsive/templates/views/product_features/compare.tpl',
      1 => 1652253997,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1509295855627c65ea564c13-97159509',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627c65ea634359_75352116',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627c65ea634359_75352116')) {function content_627c65ea634359_75352116($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_html_checkboxes')) include '/home/emartinf/public_html/app/lib/vendor/smarty/smarty/libs/plugins/function.html_checkboxes.php';
...
<span class="ty-remove__txt"><?php echo $_smarty_tpl->__("remove");?>
                            ...
                            <div class="ty-compare-products__img"><a href="<?php echo htmlspecialchars(fn_url("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['compare_product_id']->value)), ENT_QUOTES, 'UTF-8');?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['suffix'], ENT_QUOTES, 'UTF-8');
    ...
    <div class="buttons-container ty-compare__buttons">
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_text'=>$_smarty_tpl->__("clear_list"),'but_href'=>"product_features.clear_list?redirect_url=".((string)$_smarty_tpl->tpl_vars['r_url']->value),'but_meta'=>"ty-btn__tertiary"), 0);?>
