<?php /* Smarty version Smarty-3.1.21, created on 2022-05-11 17:38:28
         compiled from "/home/emartinf/public_html/design/themes/responsive/templates/common/product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1960663296627ba73c190d58-72153256%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a94a324e8baa4599201f9f9ffeca588f4e3aff1' => 
    array (
      0 => '/home/emartinf/public_html/design/themes/responsive/templates/common/product_data.tpl',
      1 => 1652253997,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1960663296627ba73c190d58-72153256',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_627ba73c4b2091_56863563',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_627ba73c4b2091_56863563')) {function content_627ba73c4b2091_56863563($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/emartinf/public_html/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_function_live_edit')) include '/home/emartinf/public_html/app/functions/smarty_plugins/function.live_edit.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('text_out_of_stock','sku','select_options','old_price','list_price','enter_your_price','contact_us_for_price','sign_in_to_view_price','inc_tax','including_tax','you_save','you_save','save_discount','free_shipping','save_discount','save_discount','availability','items','on_backorder','in_stock','availability','in_stock','on_backorder','availability','quantity','text_cart_min_qty','text_edp_product','text_out_of_stock','sku','select_options','old_price','list_price','enter_your_price','contact_us_for_price','sign_in_to_view_price','inc_tax','including_tax','you_save','you_save','save_discount','free_shipping','save_discount','save_discount','availability','items','on_backorder','in_stock','availability','in_stock','on_backorder','availability','quantity','text_cart_min_qty','text_edp_product'));
?>
...
<?php $_smarty_tpl->tpl_vars['allow_negative_amount'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['allow_negative_amount']->value)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['settings']->value['General']['allow_negative_amount'] : $tmp), null, 0);?>
...
><?php echo $_smarty_tpl->getSubTemplate ("common/image_verification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('option'=>"track_product_in_stock"), 0);
}
...
"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['price'],'span_id'=>"discounted_price_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value),'class'=>"ty-price-num",'live_editor_name'=>"product:price:".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']),'live_editor_phrase'=>$_smarty_tpl->tpl_vars['product']->value['base_price']), 0);?>
                ...
                <?php } elseif ($_smarty_tpl->tpl_vars['product']->value['zero_price_action']=="A"&&$_smarty_tpl->tpl_vars['show_add_to_cart']->value) {?>
                    <?php $_smarty_tpl->tpl_vars["base_currency"] = new Smarty_variable($_smarty_tpl->tpl_vars['currencies']->value[(defined('CART_PRIMARY_CURRENCY') ? constant('CART_PRIMARY_CURRENCY') : null)], null, 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['show_product_amount']->value&&$_smarty_tpl->tpl_vars['product']->value['is_edp']!="Y"&&$_smarty_tpl->tpl_vars['settings']->value['General']['inventory_tracking']!==smarty_modifier_enum("YesNo::NO")) {?>
    <div class="cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
