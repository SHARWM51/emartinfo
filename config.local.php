...
$config['db_name'] = 'emartinf_cscart';
$config['db_user'] = 'emartinf_cscart';
$config['db_password'] = 'V3j0fAhrmWsV';
...
$config['http_host'] = 'emartinfo.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'emartinfo.com';
$config['https_path'] = '';
