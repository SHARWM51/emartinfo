 ...
 */
function fn_master_products_get_products_post(array &$products)
{
    if (
...
function fn_master_products_get_best_product_offer($master_product_id, array $vendor_product_ids = [])
{
    ...
    if (empty($vendor_product_ids)) {
        $vendor_product_ids = $product_repository->findVendorProductIds($master_product_id, null, null, false);
